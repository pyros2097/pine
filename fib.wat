(module
    ...
    ;; (import "wasi_unstable" "environ_get" (func $environ_get (param i32 i32) (result i32)))
    ...
    ;;     ;; (call $environ_get (i32.const 2 i32.const 2))
    ;;     ;; (call $random_get (i32.const 4 i32.const 5))
    ;; )
